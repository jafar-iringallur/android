...
public class view_products extends AppCompatActivity implements TextWatcher {
    ListView list;
    EditText search;
String [] prdid,name,image,price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search=(EditText) findViewById(R.id.editTextTextPersonName25);
        ...
        String url = "http://" + hu + ":5000/android_view_shops_product";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                list.setAdapter(new Custom_view_products(getApplicationContext(),prdid,name,image,price));
                            }
...
params.put("shopid",sh.getString("shopid",""));
    ...
    public void afterTextChanged(Editable  editable) {
        ...
        String uid=sh.getString("uid","");
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/android_search_shops_product";
