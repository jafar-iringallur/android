...
public class Custom_all_products extends BaseAdapter {

    String [] prdid,pname,image,price,shop;
    private Context context;

    public Custom_all_products(Context cc,String[]prdid,String[]pname,String[]image,String[]price,String[]shop)
    {
        this.context=cc;
        this.prdid=prdid;
        this.pname=pname;
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_all_products,null);
